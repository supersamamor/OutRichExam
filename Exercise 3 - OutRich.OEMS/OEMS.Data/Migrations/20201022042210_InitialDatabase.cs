...
namespace OEMS.Data.Migrations
{
    public partial class InitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OEMSApiClient", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OEMSUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OEMSUser_AspNetUsers_IdentityId",
            ...
            migrationBuilder.Sql(@"INSERT INTO dbo.OEMSUser ([FullName],[IdentityId])
            ...
            migrationBuilder.Sql(@"Insert Into [dbo].[OEMSApiClient] (CreatedDate,UpdatedDate,CreatedByUsername,UpdatedByUsername,Token,Expiry)

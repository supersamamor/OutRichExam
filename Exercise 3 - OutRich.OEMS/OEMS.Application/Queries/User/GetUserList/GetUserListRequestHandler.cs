...
namespace OEMS.Application.Queries.User.GetUserList
{
    ...
    {       
        ...
        public GetUserListRequestHandler(OEMSContext context, MapperConfiguration mapperConfig)
        {
            _context = context;
        ...
        public async Task<StaticPagedList<UserModel>> Handle(GetUserListRequest request, CancellationToken cancellationToken)
        {
            ...
            var userList = _mapper.Map<IList<Data.Models.OEMSUser>, IList<UserModel>>(await pagedUser.ToListAsync());
